...
package syntax.method.onchange.fail11;
...
public class SyntaxCheckController {
	...
	void onChangeB11( final SortedMap<String, String> added, final SortedMap<Object, String> removed, final SortedMap<Integer, Update<String>> updated, final Collection<Move<String>> newMoved, final Collection<Move<String>> oldMoved ){}
}
