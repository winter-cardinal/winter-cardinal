...
package syntax.method.onchange.fail13;
...
public class SyntaxCheckController {
	...
	void onChangeB13( final SortedMap<String, String> added, final SortedMap<Integer, String> removed, final SortedMap<Integer, Update<Object>> updated, final Collection<Move<String>> newMoved, final Collection<Move<String>> oldMoved ){}
}
