...
package syntax.method.onchange.fail14;
...
public class SyntaxCheckController {
	...
	void onChangeB14( final SortedMap<String, String> added, final SortedMap<Integer, String> removed, final SortedMap<Integer, Update<String>> updated, final Collection<Move<Object>> newMoved, final Collection<Move<String>> oldMoved ){}
}
