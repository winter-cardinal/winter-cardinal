...
import { ServerConstructorImpl as ServerConstructor } from "../../server/internal/server-constructor-impl";
...
/**
 * Central class for making controllers received from a server.
 */
