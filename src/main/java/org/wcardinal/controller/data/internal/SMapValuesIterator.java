...
class SMapValuesIterator<V> implements Iterator<V> {
	...
	SMapValuesIterator( final SMapContainer<V> container, final Map<String, V> map, final Map<String, V> internalMap ){
